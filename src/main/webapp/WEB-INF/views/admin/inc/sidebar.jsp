        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="${pageContext.request.contextPath}/admin" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    ...
                    <div class="nav-item dropdown">
                     <a href="${pageContext.request.contextPath}/admin/orders" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-receipt me-2"></i>Orders</a>
                     <div class="dropdown-menu bg-transparent border-0">
                          <a href="${pageContext.request.contextPath}/admin/orders" class="dropdown-item">All</a>
                      </div>
                      </div>
