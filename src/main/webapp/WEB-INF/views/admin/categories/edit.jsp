    ...
    <div class="content">
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-light rounded h-100 p-4">
                ...
                <form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/categories/${category.id}/edit" class="needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Tải ảnh mới để thay thế. Bỏ trống để giữ ảnh cũ.</div>
                    </div>

                    <div class="mb-3">
                        <label class="form-label d-block">Xem trước</label>
                        <img id="preview" src="${pageContext.request.contextPath}/assets/images/${category.thumbnail}" alt="${category.name}" style="height:60px"
