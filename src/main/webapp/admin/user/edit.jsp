...
<html lang="en">
    ...
    <style>
        ...
        .form-control {
            color: #000 !important;   /* text trong input */
            background-color: #fff;   /* nền input */
        }
    </style>
    <body id="page-top">
        <!-- Page Wrapper -->
                                  ...
                                  <form action="EditUserServlet" method="post">
                                      ...
                                      <div class="mb-3">
                                          ...
                                          <input type="email" id="email" name="email" class="form-control"
                                                 value="${user.email}" style="color:#000;" required>
                                      </div>
                                      ...
                                      <div class="mb-3">
                                          ...
                                          <input type="password" id="repeatPass" name="repeatPass" class="form-control" value="${user.password}" required>
                                      </div>
    <!-- Role -->
    <div class="mb-3">
        ...
        <select name="role" id="role" class="form-select">
            ...
            <option value="admin" ${user.role == 'admin' ? 'selected' : ''}>Admin</option>
                                      ...
                                      <!-- Submit -->
                                      <div class="d-grid">
                                          <button type="submit" class="btn btn-custom text-white">Edit User</button>
                                      </div>
                                  </form>
                              </div>
                          </div>
